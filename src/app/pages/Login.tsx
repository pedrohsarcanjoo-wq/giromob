...
export function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-emerald-500/20 blur-[120px] pointer-events-none mix-blend-screen" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2 group">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-foreground/80 group-focus-within:text-emerald-400 transition-colors">Senha</label>
