    ...
    return (
      <button
        ...
        className={cn(
          ...
          "backdrop-blur-lg bg-[rgba(59,130,246,0.15)]",
          "cursor-pointer overflow-hidden",
          "before:content-[''] before:absolute before:inset-0",
          "before:rounded-[inherit] before:pointer-events-none",
          "before:z-[1]",
          "before:shadow-[inset_0_0_0_1px_rgba(59,130,246,0.3),inset_0_0_16px_0_rgba(59,130,246,0.2),inset_0_-3px_12px_0_rgba(59,130,246,0.25),0_1px_3px_0_rgba(0,0,0,0.50),0_4px_12px_0_rgba(0,0,0,0.45)]",
          "before:mix-blend-multiply before:transition-transform before:duration-300",
          "active:before:scale-[0.975]",
          "transition-all duration-200 hover:bg-[rgba(59,130,246,0.25)]",
          className
        )}
        ...
        style={{
          ...
          "--circle-end": "var(--tw-gradient-to, #3B82F6)",
